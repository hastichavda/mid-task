...
export default {
  ...
  watch: {
    msrp(val) {
      localStorage.msrp = val
    },
    dealer_discount(val) {
      localStorage.dealer_discount = val
    },
    rebates(val) {
      localStorage.rebates = val
    },
    down_das(val) {
      localStorage.down_das = val
    },
    sales_price(val) {
